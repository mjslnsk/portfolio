      ...
      <section className="py-20 px-4" id="about">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-2 mb-8">
            ...
            <h2 className="text-3xl font-pinyon text-gray-900">ABOUT ME</h2>
          </div>
      ...
      <section className="py-20 px-4 bg-pink-500" id="skills">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-2 mb-8">
            ...
            <h2 className="text-3xl font-pinyon text-gray-900">SKILLS</h2>
          </div>
...
<section className="py-20 px-4" id="projects">
  <div className="max-w-6xl mx-auto">
    <div className="flex items-center gap-2 mb-8">
      ...
      <h2 className="text-3xl font-pinyon text-gray-900">PROJECTS</h2>
    </div>
    <div className="grid md:grid-cols-2 gap-8">
      {[
        ...
        <div key={project.title} className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-6">
            <h3 className="text-xl font-bold text-gray-900 font-pixelify mb-2">{project.title}</h3>
